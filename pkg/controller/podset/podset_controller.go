...
func (r *ReconcilePodSet) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// TODO: List all pods owned by this PodSet instance
	...
	// TODO: Count the pods that are pending or running as available
	...
	// TODO: Update the status if necessary
